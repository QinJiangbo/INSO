/**  
 * @description Indexer for www.zimuku.net
...
public class ZiMuKuIndexer implements IndexCreator {
	/**
	 * create the index for the ZiMuKu
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.ZiMuKuIndex;
	 ...
	 */
	public void deleteZiMuKuIndex(String fieldName, String value) {
		try {
			String indexPath = Config.ZiMuKuIndex;
