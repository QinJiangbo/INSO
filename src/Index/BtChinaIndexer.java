/**  
 * @description Indexer for henbt.com
...
public class BtChinaIndexer implements IndexCreator {
	
	/**
	 * create the index for the BtChina
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.BtChinaIndex;
	 ...
	 */
	public void deleteBtChinaIndex(String fieldName, String value) {
		try {
			String indexPath = Config.BtChinaIndex;
	...
	public Map[] fetchDataFromDB() {
		String sql = "select * from btchina";
