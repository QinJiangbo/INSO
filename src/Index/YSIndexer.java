/**  
 * @description Indexer for www.66ys.cc
...
public class YSIndexer implements IndexCreator {
	/**
	 * create the index for the YS
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.YSIndex;
	 ...
	 */
	public void deleteYSIndex(String fieldName, String value) {
		try {
			String indexPath = Config.YSIndex;
