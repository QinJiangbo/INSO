/**  
 * @description Indexer for www.ourrelease.org
 * @author QinJiangbo 2012302580314
 * @version 1.0
 * @date Apr 25, 2015 8:42:16 PM
 */
...
public class OurReleaseIndexer implements IndexCreator {
	/**
	 * create the index for the OurRelease
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.OurReleaseIndex;
	 ...
	 */
	public void deleteOurReleaseIndex(String fieldName, String value) {
		try {
			String indexPath = Config.OurReleaseIndex;
	...
	public Map[] fetchDataFromDB() {
		String sql = "select * from ourrelease";
