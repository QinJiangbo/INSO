/**  
 * @description Indexer for BtTianTang.com
...
public class BtTianTangIndexer implements IndexCreator {
	/**
	 * create the index for the BtTianTang
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.BtTianTangIndex;
	 ...
	 */
	public void deleteBtTianTangIndex(String fieldName, String value) {
		try {
			String indexPath = Config.BtTianTangIndex;
	...
	public Map[] fetchDataFromDB() {
		String sql = "select * from bttiantang";
