...
public class ZerodmIndexer implements IndexCreator {
	
	/**
	 * create the index for the Zerodm
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.ZerodmIndex;
	 ...
	 */
	public void deleteZerodmIndex(String fieldName, String value) {
		try {
			String indexPath = Config.ZerodmIndex;
