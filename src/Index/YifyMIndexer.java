...
public class YifyMIndexer implements IndexCreator {
	/**
	...
	public void createIndex() {
		try {
			String indexPath = Config.YifyMIndex;
	 ...
	 */
	public void deleteYifyMIndex(String fieldName, String value) {
		try {
			String indexPath = Config.YifyMIndex;
