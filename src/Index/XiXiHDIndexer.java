/**  
 * @description Create the Indexes of the www.xixihd.com
 * @author QinJiangbo 2012302580314
 * @version 1.0
 * @date Apr 21, 2015 7:29:43 PM
 */
...
public class XiXiHDIndexer implements IndexCreator {
	/**
	 * create the index for the XiXiHD
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.XiXiHDIndex;
	 ...
	 */
	public void deleteXiXiHDIndex(String fieldName, String value) {
		try {
			String indexPath = Config.XiXiHDIndex;
