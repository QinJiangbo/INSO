/**  
 * @description Indexer for www.3mu.cc
...
public class ThreeMuIndexer implements IndexCreator {
	/**
	 * create the index for the ThreeMu
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.ThreeMuIndex;
	 ...
	 */
	public void deleteThreeMuIndex(String fieldName, String value) {
		try {
			String indexPath = Config.ThreeMuIndex;
	...
	public Map[] fetchDataFromDB() {
		String sql = "select * from threemu";
