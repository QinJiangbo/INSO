...
public class YifyIndexer implements IndexCreator {
	/**
	...
	public void createIndex() {
		try {
			String indexPath = Config.YifyIndex;
	 ...
	 */
	public void deleteYifyIndex(String fieldName, String value) {
		try {
			String indexPath = Config.YifyIndex;
