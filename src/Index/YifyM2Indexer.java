/**  
 * @description Indexer for www.yify-movies.org
...
public class YifyM2Indexer implements IndexCreator {
	/**
	...
	public void createIndex() {
		try {
			String indexPath = Config.YifyM2Index;
	 ...
	 */
	public void deleteYifyM2Index(String fieldName, String value) {
		try {
			String indexPath = Config.YifyM2Index;
