/**  
 * @description Indexer for d.dmm.hk
...
public class DM1080pIndexer implements IndexCreator {
	
	/**
	 * create the index for the DM1080p
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.DM1080pIndex;
	 ...
	 */
	public void deleteDM1080pIndex(String fieldName, String value) {
		try {
			String indexPath = Config.DM1080pIndex;
	...
	public Map[] fetchDataFromDB() {
		String sql = "select * from dm1080p";
