/**  
 * @description Indexer for www.dyxz.com
...
public class DYXZIndexer implements IndexCreator {
	/**
	 * create the index for the DYXZ
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.DYXZIndex;
	 ...
	 */
	public void deleteDYXZIndex(String fieldName, String value) {
		try {
			String indexPath = Config.DYXZIndex;
