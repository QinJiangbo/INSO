/**  
 * @description Create the Indexes of the www.xixizhan.com
 * @author QinJiangbo 2012302580314
 * @version 1.0
 * @date Apr 21, 2015 7:26:48 PM
 */
...
public class XiXiZhanIndexer implements IndexCreator {
	/**
	 * create the index for the XiXiZhan
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.XiXiZhanIndex;
	 ...
	 */
	public void deleteXiXiZhanIndex(String fieldName, String value) {
		try {
			String indexPath = Config.XiXiZhanIndex;
	...
	public Map[] fetchDataFromDB() {
		String sql = "select * from xixizhan";
