/**  
 * @description Index the HTML for kickass.to
 * @author QinJiangbo 2012302580314
 * @version 1.0
 * @date Apr 23, 2015 11:57:32 AM
 */
...
public class KickAssIndexer implements IndexCreator {
	/**
	 * create the index for the KickAss
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.KickAssIndex;
	 ...
	 */
	public void deleteKickAssIndex(String fieldName, String value) {
		try {
			String indexPath = Config.KickAssIndex;
	...
	public Map[] fetchDataFromDB() {
		String sql = "select * from kickass";
