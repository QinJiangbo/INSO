/**  
 * @description Indexer for www.dy2018.com
...
public class DYTTIndexer implements IndexCreator {
	/**
	 * create the index for the DYTT
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.DYTTIndex;
	 ...
	 */
	public void deleteDYTTIndex(String fieldName, String value) {
		try {
			String indexPath = Config.DYTTIndex;
