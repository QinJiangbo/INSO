/**  
 * @description Indexer for www.torrentbar.com
...
public class TorrentbarIndexer implements IndexCreator {
	/**
	 * create the index for the torrentbar
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.TorrentbarIndex;
	 ...
	 */
	public void deleteTorrentbarIndex(String fieldName, String value) {
		try {
			String indexPath = Config.TorrentbarIndex;
	...
	public Map[] fetchDataFromDB() {
		String sql = "select * from torrentbar";
