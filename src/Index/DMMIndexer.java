...
public class DMMIndexer implements IndexCreator {
	
	/**
	 * create the index for the DMM
	 */
	@SuppressWarnings("rawtypes")
	public void createIndex() {
		try {
			String indexPath = Config.DMMIndex;
	 ...
	 */
	public void deleteDMMIndex(String fieldName, String value) {
		try {
			String indexPath = Config.DMMIndex;
